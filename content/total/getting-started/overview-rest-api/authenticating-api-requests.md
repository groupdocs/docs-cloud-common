...
1. Build the URL which requires to be signed including all parameters. 
 [https://api.groupdocs.com/v1/storage/folder/test_folder](https://api.groupdocs.com/v1/storage/folder/test_folder)
1. Remove trailing '/' character if any.
1. Append App SID to the given URL as query parameter 
[http:~~/~~/api.groupdocs.com/v1/storage/folder/test_folder?appSID#c821f123-1a8b-4b97-925a-9d69a6b2fcd8](https://api.groupdocs.com/v1/storage/folder/test_folder?appSID#c821f123-1a8b-4b97-925a-9d69a6b2fcd8)
